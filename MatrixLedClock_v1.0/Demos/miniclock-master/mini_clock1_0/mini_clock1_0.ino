...
LedControl lc = LedControl(12, 11, 10, 3); //sets the 3 pins as 12, 11 & 10 and then sets 4 displays (max is 8 displays)
...
Button buttonA = Button(2);      // Setup button A (using button library)
Button buttonB = Button(3);      // Setup button B (using button library)
