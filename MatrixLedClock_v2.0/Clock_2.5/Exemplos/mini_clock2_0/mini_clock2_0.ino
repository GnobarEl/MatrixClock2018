...
bool show_intro = false;                  // Show intro at startup ?  (true/false)
...
byte clock_mode = 2;                     // Default clock mode.
...
char daysfull[7][9] = {
  "Sundat", "Monday", "Dienstag", "Mittwoch", "Donnerst", "Freitag", "Samstag"
};
...
//  get_time(); //get the time from the clock chip
  ...
  while (run_mode()) {
    ...
    if (hours == 0) { hours = 12; }
       ...
       if      (mins >= 5 && mins <= 9)  { strcpy (str_a, "F~NF");     strcpy (str_b, "NACH"); strcpy (str_c, ""); }
       else if (mins >= 10 && mins <= 14){ strcpy (str_a, "ZEHN");     strcpy (str_b, "NACH"); strcpy (str_c, ""); }
       else if (mins >= 15 && mins <= 19){ strcpy (str_a, "VIERTEL");  strcpy (str_b, "NACH"); strcpy (str_c, ""); }
       else if (mins >= 20 && mins <= 24){ strcpy (str_a, "ZEHN");     strcpy (str_b, "VOR");  strcpy (str_c, "HALB"); halb = 1; }      
       else if (mins >= 25 && mins <= 29){ strcpy (str_a, "F~NF");     strcpy (str_b, "VOR");  strcpy (str_c, "HALB"); halb = 1; }      
       else if (mins >= 30 && mins <= 34){ strcpy (str_a, "");         strcpy (str_b,    "");  strcpy (str_c, "HALB"); halb = 1; }      
       else if (mins >= 35 && mins <= 39){ strcpy (str_a, "F~NF");     strcpy (str_b, "NACH"); strcpy (str_c, "HALB"); halb = 1; }      
       else if (mins >= 40 && mins <= 44){ strcpy (str_a, "ZEHN");     strcpy (str_b, "NACH"); strcpy (str_c, "HALB"); halb = 1; }       
       else if (mins >= 45 && mins <= 49){ strcpy (str_a, "VIERTEL");  strcpy (str_b, "VOR");  strcpy (str_c, ""); halb = 1; }     
       else if (mins >= 50 && mins <= 54){ strcpy (str_a, "ZEHN");     strcpy (str_b, "VOR");  strcpy (str_c, ""); halb = 1; }       
       else if (mins >= 55 && mins <= 59){ strcpy (str_a, "F~NF");     strcpy (str_b, "VOR");  strcpy (str_c, ""); halb = 1; } 
      ...
      else if ( wordHour == 2 ) { strcpy (str_d, "ZWEI"); } 
      else if ( wordHour == 3 ) { strcpy (str_d, "DREI"); } 
      else if ( wordHour == 4 ) { strcpy (str_d, "VIER"); }
      else if ( wordHour == 5 ) { strcpy (str_d, "F~NF"); } 
      else if ( wordHour == 6 ) { strcpy (str_d, "SECHS"); } 
      else if ( wordHour == 7 ) { strcpy (str_d, "SIEBEN"); }
      else if ( wordHour == 8 ) { strcpy (str_d, "ACHT"); } 
      else if ( wordHour == 9 ) { strcpy (str_d, "NEUN"); } 
      else if ( wordHour == 10) { strcpy (str_d, "ZEHN"); }
      else if ( wordHour == 11) { strcpy (str_d, "ELF"); } 
      else if ( wordHour == 12) { strcpy (str_d, "ZW*LF"); } 
...
//  float TempC = sensors.getTempC(tempDeviceAddress);   
  String stringTempC = "24";           //data in buffer is copied to this string  
