...
/* Define constants */
#define NUM_DISPLAY_MODES 7            // Number of clock-modes  (counting zero as the first mode)
#define NUM_SETTINGS_MODES 4           // Number of settings modes = 3 (conting zero as the first mode)
...
void switch_mode() {
  ...
  const char *modes[] = {
    "Font1", "Font2", "Font3", "Font4", "Font5", "Font6", "Alarm", "Temp", "Setup",
  };
