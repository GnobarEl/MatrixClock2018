...
// clock_mode 6 = setup menu setup system settings
...
void word_clock() {
  ...
  while (run_mode()) {
    ...
    else if (mins >= 10 && mins <= 14) {
      strcpy (str_a, "ZEHN");
      strcpy (str_b, "NACH");
      strcpy (str_c, "");
    }
    else if (mins >= 15 && mins <= 19) {
      strcpy (str_a, "VIERTEL");
      strcpy (str_b, "NACH");
      strcpy (str_c, "");
    }
    else if (mins >= 20 && mins <= 24) {
      strcpy (str_a, "ZEHN");
      strcpy (str_b, "VOR");
      strcpy (str_c, "HALB");
      halb = 1;
    ...
    else if (mins >= 30 && mins <= 34) {
      strcpy (str_a, "");
      strcpy (str_b,    "");
      strcpy (str_c, "HALB");
      halb = 1;
    }
    else if (mins >= 35 && mins <= 39) {
      strcpy (str_a, "F~NF");
      strcpy (str_b, "NACH");
      strcpy (str_c, "HALB");
      halb = 1;
    }
    else if (mins >= 40 && mins <= 44) {
      strcpy (str_a, "ZEHN");
      strcpy (str_b, "NACH");
      strcpy (str_c, "HALB");
      halb = 1;
    }
    else if (mins >= 45 && mins <= 49) {
      strcpy (str_a, "VIERTEL");
      strcpy (str_b, "VOR");
      strcpy (str_c, "");
      halb = 1;
    }
    else if (mins >= 50 && mins <= 54) {
      strcpy (str_a, "ZEHN");
      strcpy (str_b, "VOR");
      strcpy (str_c, "");
      halb = 1;
    }
    else if (mins >= 55 && mins <= 59) {
      strcpy (str_a, "F~NF");
      strcpy (str_b, "VOR");
      strcpy (str_c, "");
      halb = 1;
